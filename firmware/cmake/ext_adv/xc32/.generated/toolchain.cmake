...
set(MP_CC "/usr/bin/arm-none-eabi-gcc" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler")
set(MP_CC_DIR "/usr/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "/usr/bin/arm-none-eabi-gcc" CACHE FILEPATH "Path to the compiler binary")
...
set(MP_CPPC "/usr/bin/arm-none-eabi-g++" CACHE PATH "Legacy variable from MPLAB X pointing to the c++ compiler")
set(MP_CPPC_DIR "/usr/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the c++ compiler base directory")
set(CMAKE_CXX_COMPILER "/usr/bin/arm-none-eabi-g++" CACHE FILEPATH "Path to the compiler binary.")
...
set(MP_AS "/usr/bin/arm-none-eabi-gcc" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler")
set(MP_AS_DIR "/usr/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler base directory")
set(CMAKE_ASM_COMPILER "/usr/bin/arm-none-eabi-gcc" CACHE FILEPATH "Path to the compiler binary.")
set(MP_AS "${CMAKE_ASM_COMPILER}" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the assembler binary.")

set(MP_LD "/usr/bin/arm-none-eabi-ld" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")
set(MP_LD_DIR "/usr/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the linker base directory")

set(MP_AR "/usr/bin/arm-none-eabi-ar" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")
set(MP_AR_DIR "/usr/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the archiver base directory")

set(CMAKE_AR "/usr/bin/arm-none-eabi-ar" CACHE FILEPATH "Path to the archiver binary.")

set(OBJCOPY "/usr/bin/arm-none-eabi-objcopy" CACHE FILEPATH "Path to objcopy executable")
set(OBJDUMP "/usr/bin/arm-none-eabi-objdump" CACHE FILEPATH "Path to objdump executable")
