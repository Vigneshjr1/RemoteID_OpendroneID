...
set(MP_CC "/opt/microchip/xc32/v5.10/bin/xc32-gcc" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler")
set(MP_CC_DIR "/opt/microchip/xc32/v5.10/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "/opt/microchip/xc32/v5.10/bin/xc32-gcc" CACHE FILEPATH "Path to the compiler binary")
...
set(MP_CPPC "/opt/microchip/xc32/v5.10/bin/xc32-g++" CACHE PATH "Legacy variable from MPLAB X pointing to the c++ compiler")
set(MP_CPPC_DIR "/opt/microchip/xc32/v5.10/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the c++ compiler base directory")
set(CMAKE_CXX_COMPILER "/opt/microchip/xc32/v5.10/bin/xc32-g++" CACHE FILEPATH "Path to the compiler binary.")
...
set(MP_AS "/opt/microchip/xc32/v5.10/bin/xc32-gcc" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler")
set(MP_AS_DIR "/opt/microchip/xc32/v5.10/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler base directory")
set(CMAKE_ASM_COMPILER "/opt/microchip/xc32/v5.10/bin/xc32-gcc" CACHE FILEPATH "Path to the compiler binary.")
set(MP_AS "${CMAKE_ASM_COMPILER}" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the assembler binary.")

set(MP_LD "/opt/microchip/xc32/v5.10/bin/xc32-ld" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")
set(MP_LD_DIR "/opt/microchip/xc32/v5.10/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the linker base directory")

set(MP_AR "/opt/microchip/xc32/v5.10/bin/xc32-ar" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")
set(MP_AR_DIR "/opt/microchip/xc32/v5.10/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the archiver base directory")

set(CMAKE_AR "/opt/microchip/xc32/v5.10/bin/xc32-ar" CACHE FILEPATH "Path to the archiver binary.")

set(OBJCOPY "/opt/microchip/xc32/v5.10/bin/xc32-objcopy" CACHE FILEPATH "Path to objcopy executable")
set(OBJDUMP "/opt/microchip/xc32/v5.10/bin/xc32-objdump" CACHE FILEPATH "Path to objdump executable")

set(MP_BIN2HEX "/opt/microchip/xc32/v5.10/bin/xc32-bin2hex" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the bin2hex binary.")
